...
It is installed locally and runs like so
...
SO we need to rename stuff 
java -Xmx10g -jar snpEff.jar TLL_Latcal.v3.RefSeq ../barra-lh/meta/snps-to-annotate-revision1.vcf > snps-annotated.vcf
