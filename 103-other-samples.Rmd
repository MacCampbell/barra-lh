...
bcftools +fill-tags outputs/101/renamed-05.vcf.gz  -- -t MAF,F_MISSING | bcftools view -i 'F_MISSING < 0.05' | bcftools view -i 'INFO/MAF > 0.05' |  bcftools +prune -m 0.20 -w 50kb --nsites-per-win 1 --nsites-per-win-mode rand  > outputs/101/pruned-05.vcf

bgzip outputs/101/pruned-05.vcf
tabix outputs/101/pruned-05.vcf.gz
```
...
```{r}
path_to_file <- "outputs/101/pruned-05.vcf.gz"
